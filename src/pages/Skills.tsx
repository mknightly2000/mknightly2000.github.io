            ...
            <section className="relative overflow-hidden border-b border-border/60">
                ...
                <div className="relative mx-auto max-w-6xl px-6 py-16 sm:py-20">
                    ...
                    <p className="mt-4 max-w-2xl text-balance text-base leading-relaxed text-muted-foreground sm:text-lg">
                        A live snapshot of the languages, frameworks, and habits
                        I lean on, grounded in the projects shipped and jobs
                        they powered.
                    </p>
                </div>
            </section>
